                ...
                <div class="col-lg-12">
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($category1->posts()->orderBy('created_at', 'dec')->take(3)->get() as $post)
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">Video Tutorials</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($category2->posts()->orderBy('created_at', 'dec')->take(3)->get() as $tutorial)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{$tutorial->featured}}" alt="{{$tutorial->title}}">
                                            </div>
                                            <h6 class="case-item__title text-center"><a href="{{route('post.single', ['slug' => $post->slug])}}">{{$tutorial->title}}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">Laravel</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($category3->posts()->orderBy('created_at', 'dec')->take(3)->get() as $laravel)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{$laravel->featured}}" alt="{{$laravel->title}}">
                                            </div>
                                            <h6 class="case-item__title text-center"><a href="{{route('post.single', ['slug' => $post->slug])}}">{{$laravel->title}}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
