            ...
            @if(Auth::check())
                ...
                <div class="col-lg-4">
                    <ul class="list-group">
                        ...
                        @if(Auth::user()->admin)
                            <li class="list-group-item" style="background: #E2E3E5">
                        ...
                        <li class="list-group-item" style="background: #D4EDDA">
                       ...
                       @if(Auth::user()->id == 1)
                        ...
                        <li class="list-group-item" style="background: #F2DEDE">
